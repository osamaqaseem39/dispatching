    ...
    <section className="bg-white">
      <div className="mx-auto max-w-7xl px-6 py-16">
        ...
        <div className="mt-8 grid gap-6 md:grid-cols-3">
          <div className="rounded-md border border-neutral-200 bg-white p-6 animate-glow-pulse-blue">
          ...
          <div className="rounded-md border border-neutral-200 bg-white p-6 animate-glow-pulse-green">
          ...
          <div className="rounded-md border border-neutral-200 bg-white p-6 animate-glow-pulse-orange">
