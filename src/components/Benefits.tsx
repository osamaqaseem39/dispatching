...
const IconCheck = (
  <svg viewBox="0 0 24 24" className="h-5 w-5 text-white" fill="none"><path d="m5 12 4 4 10-10" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /></svg>
);
const IconGlobe = (
  <svg viewBox="0 0 24 24" className="h-5 w-5 text-white" fill="none"><circle cx="12" cy="12" r="9" stroke="currentColor" strokeWidth="1.5" /><path d="M3 12h18M12 3c3 3 3 15 0 18M12 3c-3 3-3 15 0 18" stroke="currentColor" strokeWidth="1.5" /></svg>
);
const IconHandshake = (
  <svg viewBox="0 0 24 24" className="h-5 w-5 text-white" fill="none"><path d="M7 12 3 9m14 0 4 3M7 12l4 3 3-3m0 0 2 2 5-2m-7 0-3-3" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /></svg>
);
const IconStar = (
  <svg viewBox="0 0 24 24" className="h-5 w-5 text-white" fill="currentColor"><path d="M12 3.5 14.9 9l6.1.5-4.6 3.9 1.5 5.9L12 16.9 6.1 19.3l1.5-5.9L3 9.5 9.1 9 12 3.5Z" /></svg>
);
const IconHeadset = (
  <svg viewBox="0 0 24 24" className="h-5 w-5 text-white" fill="none"><path d="M4 13a8 8 0 1 1 16 0v5a2 2 0 0 1-2 2h-2v-6h4" stroke="currentColor" strokeWidth="1.5" /><path d="M8 20H6a2 2 0 0 1-2-2v-5h4v7Z" stroke="currentColor" strokeWidth="1.5" /></svg>
);
const IconShield = (
  <svg viewBox="0 0 24 24" className="h-5 w-5 text-white" fill="none"><path d="M12 3 4 6v6c0 5 3.5 7.5 8 9 4.5-1.5 8-4 8-9V6l-8-3Z" stroke="currentColor" strokeWidth="1.5" /></svg>
);
