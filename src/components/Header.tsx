            ...
            <div className="bg-neutral-900/95 backdrop-blur rounded-2xl border border-neutral-800/80 shadow-lg shadow-black/30 p-6">
              <nav className="flex flex-col space-y-4">
                ...
                <div className="pt-2 border-t border-neutral-800">
                  <Link href="/contact" className="inline-flex items-center justify-center w-full rounded-lg bg-white px-6 py-3 text-neutral-950 text-sm font-medium hover:bg-neutral-200 transition-colors">
                    Get Started
                  </Link>
                </div>
              </nav>
